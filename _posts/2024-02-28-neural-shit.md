...
<div class="l-page">
  {% include figure.liquid path="../../assets/img/images/mouse_integration.png" alt="mouse integration" class="img-fluid rounded z-depth-1" zoomable=true %}</div>
...
<div class="l-page">
  {% include figure.liquid path="assets/img/pi_exp_1.png" alt="pi 1" class="img-fluid rounded z-depth-1" zoomable=true %}</div>
